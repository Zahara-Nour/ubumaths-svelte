      ...
      Résultat:[
        {
          ...
          subdescription: "Nombres entiers à 1 chiffre (sans retenue)",
          expressions: ["&1 + &2","&1 + &2"],
          variables: [{ "&1": "$e[5;7]", "&2": "$e[2;9-&1]" },{ "&1": "$e[2;4]", "&2": "$e[2;9-&1]" }],
          type: "result",
          defaultDelay: 10
        },
        {
    ...
    Soustraction:{
        "Résultat":[
              ...
              },
              {
                ...
                variables: [{ "&1": "$e[2;9]", "&2":"$e[5;9]", "&3":"$e[1;&1-1]", "&4":"$e[1;&2-1]"  }],
              ...
              },
              {
                ...
                variables: [{ "&1": "$e[2;9]", "&2":"$e[2;9]", "&3":"$e[5;9]", "&4":"$e[1;&1-1]", "&5":"$e[1;&2-1]", "&6":"$e[1;&3-1]"  }],
         ...
         "A trou": [
              ...
              },
              {
                description: "Compléter une soustraction à trou (résultat positif)",
                subdescription: "Nombres à 2 chiffres sans retenue.",
                expressions: ["#{ &1*10 + &2 } - ? =  #{ &3*10 + &4 }", "? - #{ &1*10 + &2 } =  #{ &3*10 + &4 }"],
                variables: [{ "&1": "$e[2;9]", "&2":"$e[2;9]", "&3":"$e[1;&1-1]", "&4":"$e[1;&2-1]"},
              {"&1": "$e[2;8]", "&2":"$e[2;8]", "&3":"$e[1;9-&1]", "&4":"$e[1;9-&2]"}],
                solutions: ["#{ &1*10 + &2 -  ( &3*10 + &4) }", "#{ &1*10 + &2 + &3*10 + &4 }"],
                type:"trou",
                defaultDelay: 15,
              },
              {
                description: "Compléter une soustraction à trou (résultat positif)",
                subdescription: "Nombres à 3 chiffres (sans retenue)",
                expressions: ["#{ &1*100 + &2*10 + &3 } - ? = #{ &4*100 + &5*10 + &6 }", "? - #{ &1*100 + &2*10 + &3 } = #{ &4*100 + &5*10 + &6 }"],
                variables: [{ "&1": "$e[2;9]", "&2":"$e[2;9]", "&3":"$e[2;9]", "&4":"$e[1;&1-1]", "&5":"$e[1;&2-1]", "&6":"$e[1;&3-1]"},
                {"&1": "$e[2;8]", "&2":"$e[2;8]", "&3":"$e[2;8]", "&4":"$e[1;9-&1]", "&5":"$e[1;9-&2]", "&6":"$e[1;9-&3]"}],
                solutions:["#{ &1*100 + &2*10 + &3 - (&4*100 + &5*10 + &6) }","#{ &1*100 + &2*10 + &3 + &4*100 + &5*10 + &6 }"],
                type:"trou",
                defaultDelay: 20,
              },
              {          
                description: "Compléter une soustraction à trou (résultat positif)",
                subdescription: "Nombres à 2 chiffres (avec retenue)",
                expressions: ["#{ &1*10 + &4 } - ? =  #{ &3*10 + &2 }", "? - #{ &1*10 + &2 } =  #{ &3*10 + &4 }"],
                variables: [{ "&1": "$e[3;9]", "&2":"$e[2;9]", "&3":"$e[1;&1-2]", "&4":"$e[1;&2-1]"},
                {"&1": "$e[1;7]", "&2":"$e[1;9]", "&3":"$e[1;8-&1]", "&4":"$e[9-&2+1;9]"}],
                solutions:["#{ &1*10 + &4 - (&3*10 + &2 )}","#{ &1*10 + &2 + &3*10 + &4 }"],
                type:"trou",
                defaultDelay: 15,
              ...
              },
              {
                description: "Compléter une soustraction à trou (résultat positif)",
                subdescription: "Nombres à 3 chiffres (avec retenue)",
                expressions: ["#{ &1*100 + &5*10 + &6 } - ? =  #{ &4*100 + &2*10 + &3 }", "? - #{ &1*100 + &2*10 + &3 } =  #{ &4*100 + &5*10 + &6}"],
                variables: [{ "&1": "$e[3;9]", "&2":"$e[2;9]", "&3":"$e[2;9]", "&4":"$e[1;&1-2]", "&5":"$e[1;&2-1]", "&6":"$e[1;&3-1]"  },
                {"&1": "$e[1;7]", "&2":"$e[1;9]", "&3":"$e[1;9]", "&4":"$e[1;8-&1]", "&5":"$e[9-&2+1;9]", "&6":"$e[9-&3+1;9]"}],
                solutions:["#{ &1*100 + &5*10 + &6 - (&4*100 + &2*10 + &3) }", "#{&1*100 + &2*10 + &3 + &4*100 + &5*10 + &6}"],
                type:"trou",
                defaultDelay: 20,
              }
            ]
